...
from mmcv.runner import load_checkpoint, init_dist, wrap_fp16_model
...
def load_ckpt(model, ckpt_path, map_location="cpu"):
    ...
    for k, v in state_dict.items():
        # remove possible prefixes like 'model.', 'module.' and lightning
        # nested 'model.model.' prefixes
...
def main():
    ...
    motion_length_tensor = torch.tensor([[motion_length]], dtype=torch.long, device=device)
    ...
    print("type of output: ", type(pred_motion))
    print("shape of output:", pred_motion.shape)
