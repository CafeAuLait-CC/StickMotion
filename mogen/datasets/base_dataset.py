...
class BaseMotionDataset(Dataset):
    ...
    def load_annotations(self):
        ...
        self.data_infos = []
        lines = open(self.ann_file, 'r').readlines()
        lines = [line.strip() for line in lines]#[:100]#!!!!!!!!!!!!!!
        ...
        #     results = list(executor.map(self.load_anno, lines))
        # self.data_infos = [result for result in results if result is not None]
